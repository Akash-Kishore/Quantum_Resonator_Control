...
class ResonatorEnv(gym.Env):
    ...
    def __init__(self):
        ...
        # Action space: continuous frequency shift bounded between -1.0 and 1.0 (scales to +/- 2000 Hz)
    ...
    def step(self, action):
        ...
        # Apply action to shift frequency (+/- 2000 Hz max)
        freq_shift = action[0] * 2000 
