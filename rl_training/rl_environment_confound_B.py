...
class ResonatorEnv(gym.Env):
    """
    Confound B: V3 observation (4-element) with V4 reward (same as V3 reward currently).
    """
    def __init__(self):
...
if __name__ == "__main__":
    env = ResonatorEnv()
    obs, _ = env.reset()
    print(f"Confound B env initialized. obs length: {len(obs)}")