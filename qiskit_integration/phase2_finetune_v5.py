...
# Original V4 Seed 3 checkpoint
MODEL_PATH = (
    r"C:\MiniProject_Sem4\rl_training\trained_models"
    r"\v4_gradient_obs\seed_3\best_model"
)
# Original vec_normalize.pkl
STATS_PATH = (
    r"C:\MiniProject_Sem4\rl_training\trained_models"
    r"\v4_gradient_obs\seed_3\vec_normalize.pkl"
)
# New save directory for v5
SAVE_DIR = r"C:\MiniProject_Sem4\data_logs" r"\qiskit_aer_simulation_2\v4_qft_v5"
...
model.save(os.path.join(SAVE_DIR, "v4_qft_v5_final"))
train_b.save(os.path.join(SAVE_DIR, "vec_normalize_qft_v5.pkl"))
print("V5 fine-tuning complete. Saved to:", SAVE_DIR)
